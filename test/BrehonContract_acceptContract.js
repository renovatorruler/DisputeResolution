...
contract('BrehonContract acceptContract method should allow partyA to accept the contract', (accounts) => {
...
contract('BrehonContract acceptContract method should allow partyB to accept the contract', (accounts) => {
...
contract('BrehonContract acceptContract method should allow primaryBrehon to accept the contract', (accounts) => {
...
contract('BrehonContract acceptContract method should allow secondaryBrehon to accept the contract', (accounts) => {
...
contract('BrehonContract acceptContract method should allow tertiaryBrehon to accept the contract', (accounts) => {
...
contract('BrehonContract acceptContract should ', (accounts) => {
